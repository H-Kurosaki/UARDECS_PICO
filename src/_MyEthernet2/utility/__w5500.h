...
#ifndef	_MYETH2_W5500_H
#define	_MYETH2_W5500_H
...
enum W5500Error {
  W5500_ERR_NONE = 0,
  W5500_ERR_TIMEOUT_RX_SIZE = 1,
  W5500_ERR_TIMEOUT_TX_SIZE = 2,
  W5500_ERR_TIMEOUT_CMD = 3,
  W5500_ERR_SPI_FAILURE = 4,
  W5500_ERR_TIMEOUT_OTHER = 5
};
...
// エラー管理用の新しいメンバー(2025/11/04 kurosaki)
  static W5500Error getLastError();
  static void clearError();
  static const char* getErrorString(W5500Error err);
  static void setError(W5500Error err);   // 内部用エラー設定(2025/11/04 kurosaki)
  ...
  // ---------------
private:
  static volatile W5500Error _lastError;  // エラーステータス保持(2025/11/04 kurosaki)
